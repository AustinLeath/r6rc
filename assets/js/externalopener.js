...
document
  .getElementById("githubprofile_al")
...
document
  .getElementById("githubprofile_wh")
  .addEventListener("click", function(e) {
    e.preventDefault();
    var remoteLink = this.getAttribute("href");
    shell.openExternal(remoteLink);
...
document
  .getElementById("githubprofile_jg")
  .addEventListener("click", function(e) {
    e.preventDefault();
    var remoteLink = this.getAttribute("href");
    shell.openExternal(remoteLink);
...
document
  .getElementById("austinleath.comclick")
  .addEventListener("click", function(e) {
    e.preventDefault();
    var remoteLink = this.getAttribute("href");
    shell.openExternal(remoteLink);
